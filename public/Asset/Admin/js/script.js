...
let Resmenubtn = document.querySelector("#ResmenuBar");
let BlurBack = document.querySelector(".blur-background");

Resmenubtn.addEventListener("click", function (e) {
    sidebar.classList.toggle("Res-active");
    BlurBack.classList.toggle("active");
   
});
BlurBack.addEventListener("click", function (e) {
    sidebar.classList.toggle("Res-active");
    BlurBack.classList.toggle("active");
