...
@section('content')
    <div class="content">
        <div class="title mt-3">
            <h1 class="mb-2">Sub-Category Detail</h1>
                ...
                <div class="admin-main-detail-chart-container">
                    <div class="admin-main-detail-chart-card">
                        <div class="admin-main-detail-chart-card-header">
                            <h3>Sub-Category Product Summary</h3>
                        </div>
...
@section('script')
    <script src="{{ asset('Asset/Admin/js/Category/detail.js') }}"></script>
@endsection
