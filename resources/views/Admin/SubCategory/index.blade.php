...
@section('content')
    <div class="content">
        <div class="title mt-3">
            <h1 class="mb-2">All Sub-Categories</h1>
                ...
                <div class="admin-main-table-header">
                    ...
                    <div class="admin-main-table-header-sub">
                        <form name="SearchForm" id="SearchForm">
                            <input type="text" name="keyword" id="keyword" placeholder="Search Sub-Categories..">
                            <a href="javascript:void(0)">
                                <i class="fa-solid fa-magnifying-glass"></i>
                            </a>
                        </form>
                        <a href="{{ route('Admin.Subcategory.create') }}" class="admin-main-table-header-button">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="table-action">
                                        ...
                                        <a href="{{ route('Admin.Subcategory.edit') }}" class="table-action-btn" style="--i: 12 , 215, 177;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="table-action">
                                        <a href="{{ route('Admin.Subcategory.show') }}" class="table-action-btn" style="--i: 84 , 109, 254;">
                                            <i class="fa-regular fa-eye"></i>
                                        </a>
...
@section('script')
    <script src="{{ asset('Asset/Admin/js/SubCategory/index.js') }}"></script>
@endsection
