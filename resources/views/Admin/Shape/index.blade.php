                ...
                <div class="admin-main-table-header">
                    ...
                    <div class="admin-main-table-header-sub">
                        <form name="SearchForm" id="SearchForm">
                            <input type="text" name="keyword" id="keyword" placeholder="Search Shapes..">
                            <a href="javascript:void(0)">
                                <i class="fa-solid fa-magnifying-glass"></i>
                            </a>
                        </form>
                        <a href="{{ route('Admin.shape.create') }}" class="admin-main-table-header-button">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="table-action">
                                        <a href="{{ route('Admin.shape.edit') }}" class="table-action-btn" style="--i: 12 , 215, 177;">
