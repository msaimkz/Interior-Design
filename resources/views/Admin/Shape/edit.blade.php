                                ...
                                <div class="admin-main-form-left-card-body">
                                    <div class="admin-main-form-left-small-card">
                                        ...
                                        <input type="text" name="name" id="name" class="form-control"
                                            placeholder="Shape Name" value="">
                                        <span class="admin-invalid-feedback"></span>
                                    </div>
                                    <div class="admin-main-form-left-small-card">
                                        <h3>Shape Slug</h3>
                                        <input type="text" name="slug" id="slug" class="form-control"
                                            placeholder="Shape Slug" value="">
                                        <span class="admin-invalid-feedback"></span>
                                    </div>
                                    <div class="admin-main-form-left-small-card">
                                        <h3>Shape Height</h3>
                                        <input type="text" name="height" id="height" class="form-control"
                                            placeholder="Shape Height" value="">
                                        <span class="admin-invalid-feedback"></span>
                                    </div>
