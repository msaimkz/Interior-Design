                ...
                <div class="admin-main-table-header">
                    ...
                    <div class="admin-main-table-header-sub">
                        <form name="SearchForm" id="SearchForm">
                            <input type="text" name="keyword" id="keyword" placeholder="Search Brands..">
                            <a href="javascript:void(0)">
                                <i class="fa-solid fa-magnifying-glass"></i>
                            </a>
                        </form>
                        <a href="{{ route('Admin.brand.create') }}" class="admin-main-table-header-button">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="table-action">
                                        <a href="{{ route('Admin.brand.show') }}" class="table-action-btn" style="--i: 84 , 109, 254;">
                                            <i class="fa-regular fa-eye"></i>
                                        </a>
                                        <a href="{{ route('Admin.brand.edit') }}" class="table-action-btn" style="--i: 12 , 215, 177;">
...
@section('script')
    <script src="{{ asset('Asset/Admin/js/Brand/index.js') }}"></script>
@endsection
